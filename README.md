...
Kotlin Multiplatform line-by-line clean-room port of the Rust crate [`globset`](https://crates.io/crates/globset).

> **Status: scaffold — porting has not started.** This repo currently contains build infrastructure only. The upstream Rust source for the `globset` crate will be cloned into `tmp/` (gitignored) when porting begins.

## About

Compiled glob set / matcher
...
Original work copyrighted by the upstream `globset` authors. Kotlin port copyright (c) 2026 Sydney Renee and The Solace Project.

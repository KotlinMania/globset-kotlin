...
This is a Kotlin Multiplatform line-by-line transliteration port of [`BurntSushi/ripgrep`](https://github.com/BurntSushi/ripgrep/tree/master/crates/globset).

**Original Project:** This port is based on [`BurntSushi/ripgrep`](https://github.com/BurntSushi/ripgrep/tree/master/crates/globset). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
> The text below is reproduced and lightly edited from [`https://github.com/BurntSushi/ripgrep/tree/master/crates/globset`](https://github.com/BurntSushi/ripgrep/tree/master/crates/globset). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:globset-kotlin:0.1.0-SNAPSHOT")
}
```
...
This Kotlin port is distributed under the same Unlicense license as the upstream [`BurntSushi/ripgrep`](https://github.com/BurntSushi/ripgrep/tree/master/crates/globset). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
...
Thanks to the [`BurntSushi/ripgrep`](https://github.com/BurntSushi/ripgrep/tree/master/crates/globset) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.

...
kotlin {
    ...
    swiftExport {
        moduleName = "Globset"
        flattenPackage = "io.github.kotlinmania.globset"
    }

    android {
        namespace = "io.github.kotlinmania.globset"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "globset-kotlin", version.toString())

    pom {
        name.set("globset-kotlin")
        description.set("Kotlin Multiplatform port of BurntSushi/ripgrep - Cross platform single glob and glob set matching. Glob set matching is the process of matching one or more glob patterns against a single candidate path simultaneously, and returning all of the globs that matched")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/globset-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/globset-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/globset-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/globset-kotlin.git")
        }
    }
}

...
| `src/commonTest/kotlin/io/github/kotlinmania/globset/benches/Bench.kt` | `// port-lint: source globset/benches/bench.rs` | `// port-lint: source benches/bench.rs` | `benches/bench.rs` | `port-lint provenance header matched only by basename: 'globset/benches/bench.rs' vs expected 'benches/bench.rs'` |
| `src/commonTest/kotlin/io/github/kotlinmania/globset/BenchTests.kt` | `// port-lint: tests globset/benches/bench.rs` | `// port-lint: tests benches/bench.rs` | `benches/bench.rs` | `port-lint provenance header matched only by basename: 'tests:globset/benches/bench.rs' vs expected 'benches/bench.rs'` |

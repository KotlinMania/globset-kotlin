...
This file is the quick-reference operating contract for globset-kotlin. The longer
...
globset-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`globset`](https://crates.io/crates/globset). Upstream Rust is the behavioral oracle while the
